...
--DROP VIEW Vw_RetornaTabela;

CREATE VIEW Vw_RetornaTabela AS
SELECT 
    isbn , titulo AS 'Título', ano, Editora.nome AS 'Nome Editora' ,concat(autor.nome, ' (' ,autor.nacionalidade, ')') as  'Autor/Nascionalidade' , Categoria.tipo_categoria  
FROM Livro
